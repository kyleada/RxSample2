 ...
 */
public class BikeListFragment2 extends BaseFragment implements android.support.v4.widget.SwipeRefreshLayout.OnRefreshListener,RecyclerArrayAdapter.OnLoadMoreListener,IBikeListView {
    ...
    protected int getContentViewLayoutID() {
        return R.layout.fragment_bike_list2;
    }
    ...
    protected void initViewsAndEvents(View view) {
        ...
        rvBikelist.setAdapter(bikeListAdapter = new BikeListAdapter(mContext));
...
//                })
    ...
    public static BikeListFragment2 newInstance() {

        BikeListFragment2 fragment = new BikeListFragment2();
